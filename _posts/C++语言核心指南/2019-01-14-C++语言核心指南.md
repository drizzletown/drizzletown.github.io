...
* 查看来自输入的未检查值
* 查看结构化数据（具有不变性的类对象objects of classes with invariants）被转换为字符串的情况
* ???
...
* [I.4: 使接口精确且强类型化（Make interfaces precisely and strongly typed）](#Ri-typed)
